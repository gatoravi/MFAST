...
#Find the frequent seeds(70%) amongst the potential seeds!
...
while (<IN>){    
	...
	#Write the seeds and frequencies for the 70 pc case !
	$out_file2 = ">".$op_file;
	open(OUT2, $out_file2);
	$out_file2_f = ">".$op_file."_frequencies";
...
print"\nSorting $op_file\n";
`perl sort_freq_seeds.pl $op_file`;
print"Done !\n";
